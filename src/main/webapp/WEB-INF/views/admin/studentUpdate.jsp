...
<div class="right">
	<div class="location">
		<strong>你现在所在的位置是:</strong> <span>学生管理页面 >> 学生修改页面</span>
	</div>
	<div class="providerAdd">
		<form id="form" action="updateStudent.do" method="post"
			enctype="multipart/form-data">
			<input type="hidden" name="stuid" value="${stu.stuid }">
			<div>
				<label for="stunickname">学生昵称：</label> <input type="text"
					name="stunickname" id="stunickname" value="${stu.stunickname }" />
				<span>*请输入学生昵称</span>
			</div>
			<div>
				<label for="stupsw">密码：</label> <input type="text" name="stupsw"
					id="stupsw" value="${stu.stupsw }" /> <span>*请输入密码</span>
			</div>
			<div>
			...
			<div>
				<label for="stuphone">联系方式：</label> <input type="text"
					name="stuphone" id="stuphone" value="${stu.stuphone }" /> <span>*请输入联系方式</span>
			</div>
			<div>
				<label for="stumail">邮箱：</label> <input type="email" name="stumail"
					id="stumail" value="${stu.stumail }" /> <span>*请输入邮箱</span>
			</div>
			<div>
